...
# ======================================================================================================================
    ...
    time.sleep(a)
    print(CYAN + "Path #3:", GREEN + "Be a brave man & wait for it to get to the second floor since you have a dagger")
    time.sleep(a)
...
def choices():
    ...
    firstPath = input(YELLOW + "Choose a path (1/2/3/4): ")
    print()
    print(GREEN + "---------------------------------------------------------------------------------------------------")
    time.sleep(a)
    print(YELLOW + "Choice Selected:")  # Choices
    ...
    if firstPath == '1':
        ...
        time.sleep(d)
        print("Narrator: You die...since the window is far away from the floor ")
        time.sleep(d)
        exit()
    print(GREEN)  # Space
    print("===========================================================================================================")
